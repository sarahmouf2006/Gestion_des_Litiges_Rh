    ...
    <div class="row justify-content-center">
        <div class="col-lg-10 col-xl-8">
            <div class="card-modern">
                ...
                <form action="{{ route('jugement.update', $jugement->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   name="رقم_تأجير" 
                                   class="form-control" 
                                   value="{{ old('رقم_تأجير', $jugement->{'رقم تأجير'}) }}" 
                                   required 
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   name="الاسم_و_النسب" 
                                   class="form-control" 
                                   value="{{ old('الاسم_و_النسب', $jugement->{'الاسم و النسب'}) }}" 
                                   required
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   name="الإطار" 
                                   class="form-control" 
                                   value="{{ old('الإطار', $jugement->{'الإطار'}) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   name="نوع_العملية" 
                                   class="form-control" 
                                   value="{{ old('نوع_العملية', $jugement->{'نوع العملية'}) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   name="الفترة" 
                                   class="form-control" 
                                   value="{{ old('الفترة', $jugement->{'الفترة'}) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   name="ملاحظات" 
                                   class="form-control" 
                                   value="{{ old('ملاحظات', $jugement->{'ملاحظات'}) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   class="form-control" 
                                   value="{{ old('المديرية_الإقليمية', $jugement->{'المديرية الإقليمية'}) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   name="ملاحظات1" 
                                   class="form-control" 
                                   value="{{ old('ملاحظات1', $jugement->{'ملاحظات1'}) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" 
                                   ...
                                   name="تاريخ_التسوية" 
                                   class="form-control" 
                                   value="{{ old('تاريخ_التسوية', $jugement->{'تاريخ التسوية'}) }}">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" 
                                   ...
                                   name="مبلغ_التعويض" 
                                   class="form-control" 
                                   value="{{ old('مبلغ_التعويض', $jugement->{'مبلغ التعويض'}) }}"
                                   step="0.01"
                                   placeholder="0.00">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" 
                                   ...
                                   name="تاريخ_الالتحاق" 
                                   class="form-control" 
                                   value="{{ old('تاريخ_الالتحاق', $jugement->{'تاريخ الالتحاق'}) }}">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" 
                                   ...
                                   class="form-control" 
                                   value="{{ old('التسوية_النهائية', $jugement->{'التسوية النهائية'}) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="منفذة_أو_غير_منفذة" 
                                    ...
                                    class="form-control">
                                <option value="1" {{ old('منفذة_أو_غير_منفذة', $jugement->{'منفذة أو غير منفذة'}) == 1 ? 'selected' : '' }}>منفذة</option>
                                <option value="0" {{ old('منفذة_أو_غير_منفذة', $jugement->{'منفذة أو غير منفذة'}) == 0 ? 'selected' : '' }}>غير منفذة</option>
                            </select>
                        </div>
                    </div>
